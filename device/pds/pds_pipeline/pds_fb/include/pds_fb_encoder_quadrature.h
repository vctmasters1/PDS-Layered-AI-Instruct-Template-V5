/**
 * PDS Function Block — Quadrature Encoder (fb_encoder_quadrature)
 *
...
#ifndef PDS_FB_ENCODER_QUADRATURE_H
#define PDS_FB_ENCODER_QUADRATURE_H
...
/*
 * Struct layout (16 bytes, natural alignment on ESP32):
...
typedef struct {
    ...
    bool     active_low;           /**< Invert A/B/Z logic levels at runtime (polarity, not GPIO bias) */
...
} pds_fb_encoder_quadrature_settings_t;
...
} pds_fb_encoder_quadrature_state_t;
...
#endif /* PDS_FB_ENCODER_QUADRATURE_H */
